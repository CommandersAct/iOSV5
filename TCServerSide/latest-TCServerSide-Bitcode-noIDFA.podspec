Pod::Spec.new do |s|
  s.name         = "latest-TCServerSide-Bitcode-noIDFA"
  s.version      = "5.1.0"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/iOSV5/tree/master/TCServerSide for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/iOSV5/raw/master/TCServerSide/5/1/0/TCServerSide-Bitcode-noIDFA.zip" }
